module.exports = class GiveRole {
    static match(message) {
        ...
        return message.content.startsWith(prefix + 'giverole')
    }
    static action(message) {
        ...
        member.addRole(thingToEcho.replace("<@&","").replace(">",""))
        message.channel.send('Le rôle de ' + member.displayName + ' a bien été mis à jour :white_check_mark:')
        }else {
            message.reply("Mes permissions ne sont pas aussi haute que tu le crois.")
        }
    }
}