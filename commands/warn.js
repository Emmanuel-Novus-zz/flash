module.exports = class Warn {
  static match(message) {
    ...
    return message.content.startsWith(prefix + 'warn')
  }
  ...
  static action(message) {
    const Discord = require('discord.js');
        ...
        var warn = new Discord.RichEmbed()
            .setDescription(":white_check_mark: Nouveau utilisateur avertis")
            .addField("Utilisateur avertis:", member.displayName)
